...
Route::prefix('classifications')->group(function () {
    ...
    Route::post('/{externalId}/reanalyze', [ClassificationController::class, 'reanalyze'])->middleware('permission:classifications_update')->name('classifications.api.reanalyze');
});
